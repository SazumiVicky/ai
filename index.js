...
const donet = "https://saweria.co/sazumi";
const owner = ["6285236226786"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator https://saweria.co/sazumi", "yellow"));
